	...
	static void setUp() {
	 ...
	 @Test
	    void testSaveFeedback() {
		 	Room room = roomService.getRoomById(1001L);
		 	Hotel hotel = new Hotel('V',2L,"VV Hotel","vk@gmail.com","Hyderabad",9988774455L);
	    ...
	    void testGetHotelById() {
	        Hotel hotel = hotelService.getHotelById(2L);
	        assertNotNull(hotel);
	    ...
	    void testDeleteHotel() {
	        assertTrue(hotelService.deleteHotel(2L));
	    }  
